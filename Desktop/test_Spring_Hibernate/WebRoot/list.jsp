...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <s:property value="username"/> - Web Developer
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">File_system</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="compose.action" class="btn btn-primary btn-block margin-bottom">Compose</a>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Personnal File</h3>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table id="table1" class="table table-hover table-striped">
                  <tbody >
                  <s:iterator value="filemap" id="id" status="st">	
		          <tr>
                    <td><input type="checkbox" name="<s:property value="key" />"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"></td>
                    <td 
                    class="mailbox-subject">
                    <a href="filedownload.action?fn=<s:property value="key" />"><b><s:property value="key"/></b></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<s:property value="value"/> 
                    </td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2015 <a href="#">Sainty</a>.</strong> All rights
    reserved.
  </footer>
